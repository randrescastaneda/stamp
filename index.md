...
> is installed. To migrate to `.qs2`, load with
> [`st_load()`](https://randrescastaneda.github.io/stamp/reference/st_load.md)
> and re-save with `format = "qs2"`. The `.qs2` format offers better
...
- **[`st_opts()`](https://randrescastaneda.github.io/stamp/reference/st_opts.md)** -
  Get or set package options (versioning mode, retention policies,
  metadata format)
