...
#> ✔ stamp initialized
#>   root: /tmp/RtmpYzxMhd/s
#>   state: /tmp/RtmpYzxMhd/s/.stamp
...
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2 @ version
#>   7f798e3e0a8e977c
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2 @ version
#>   a6136378a2d9ae24
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2 @ version
#>   87dd6ee4ad3d4ec9
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/data/welfare/MEX_2015.qs2 @ version
#>   341d58478df6d396
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/data/welfare/PRY_2011.qs2 @ version
#>   adacd011a6868f42
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/data/welfare/PRY_2014.qs2 @ version
#>   2748db71009938aa
unlist(welfare_paths)
#> [1] "/tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2"
#> [2] "/tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2"
#> [3] "/tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2"
#> [4] "/tmp/RtmpYzxMhd/s/data/welfare/MEX_2015.qs2"
#> [5] "/tmp/RtmpYzxMhd/s/data/welfare/PRY_2011.qs2"
#> [6] "/tmp/RtmpYzxMhd/s/data/welfare/PRY_2014.qs2"
```
...
#> 
#> $snapshot_dir
#> /tmp/RtmpYzxMhd/s/.stamp/versions/data/welfare/COL_2010.qs2/7f798e3e0a8e977c
#> 
#> $parents
#> list()
```
...
#> ✔ Saved [qs2] →
#> /tmp/RtmpYzxMhd/s/data/macro/cpi.qs2 @ version a69fb33f8920b218
st_save(
  pop,
...
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/data/macro/population.qs2 @ version
#>   87ab5d5168392691
st_save(
  gdp,
...
#> ✔ Saved [qs2] →
#> /tmp/RtmpYzxMhd/s/data/macro/gdp.qs2 @ version 522c12cd387f0223
```
...
summary_table <- foo()
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/MEX_2015.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/PRY_2011.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/PRY_2014.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/macro/cpi.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/macro/gdp.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/macro/population.qs2
head(summary_table)
#> Key: <country, year>
...
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 @ version
#>   cc4cb6fe1c0658f8
st_lineage(out_summary_path, depth = 1)
#>   level                                    child_path    child_version
#> 1     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#> 2     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#> 3     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#> 4     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#> 5     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#> 6     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#> 7     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#> 8     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#> 9     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 cc4cb6fe1c0658f8
#>                                   parent_path   parent_version
#> 1 /tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2 7f798e3e0a8e977c
#> 2 /tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2 a6136378a2d9ae24
#> 3 /tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2 87dd6ee4ad3d4ec9
#> 4 /tmp/RtmpYzxMhd/s/data/welfare/MEX_2015.qs2 341d58478df6d396
#> 5 /tmp/RtmpYzxMhd/s/data/welfare/PRY_2011.qs2 adacd011a6868f42
#> 6 /tmp/RtmpYzxMhd/s/data/welfare/PRY_2014.qs2 2748db71009938aa
#> 7        /tmp/RtmpYzxMhd/s/data/macro/cpi.qs2 a69fb33f8920b218
#> 8        /tmp/RtmpYzxMhd/s/data/macro/gdp.qs2 522c12cd387f0223
#> 9 /tmp/RtmpYzxMhd/s/data/macro/population.qs2 87ab5d5168392691
```
...
#> ✔ Loaded [qs2] ←
#> /tmp/RtmpYzxMhd/s/data/macro/cpi.qs2
gdp_tbl <- st_load(fs::path(macro_dir, "gdp.qs2"))
#> ✔ Loaded [qs2] ←
#> /tmp/RtmpYzxMhd/s/data/macro/gdp.qs2
pop_tbl <- st_load(fs::path(macro_dir, "population.qs2"))
#> ✔ Loaded [qs2] ←
#> /tmp/RtmpYzxMhd/s/data/macro/population.qs2
...
st_lineage(out_summary_path, depth = 1)
#>   level                                    child_path    child_version
#> 1     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#> 2     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#> 3     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#> 4     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#> 5     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#> 6     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#> 7     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#> 8     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#> 9     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 18cbc632085f3f9a
#>                                   parent_path   parent_version
#> 1 /tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2 7f798e3e0a8e977c
#> 2 /tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2 a6136378a2d9ae24
#> 3 /tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2 87dd6ee4ad3d4ec9
...
#> ✔ Saved [qs2] →
#> /tmp/RtmpYzxMhd/s/data/macro/cpi.qs2 @ version aae53c4d934cc97f
st_versions(fs::path(macro_dir, "cpi.qs2"))[1:3]
#>          version_id      artifact_id     content_hash code_hash size_bytes
#>              <char>           <char>           <char>    <char>      <num>
#> 1: aae53c4d934cc97f 61f1496a15838954 7ecab5cc3c1c678f      <NA>        890
#> 2: a69fb33f8920b218 61f1496a15838954 a0a1d1f0acc4fb3a      <NA>        874
#> 3:             <NA>             <NA>             <NA>      <NA>         NA
#>              created_at sidecar_format
#>                  <char>         <char>
#> 1: 2025-11-26T15:30:58Z           json
#> 2: 2025-11-26T15:30:56Z           json
#> 3:                 <NA>           <NA>
...
#> ✔ Registered builder for /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2
#>   (default)
```
...
print(plan)
#>   level                                          path         reason
#> 1     0 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 parent_changed
...
#>   • /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 (parent_changed)
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/MEX_2015.qs2
...
st_lineage(out_summary_path, depth = 1)
#>   level                                    child_path    child_version
#> 1     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#> 2     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#> 3     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#> 4     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#> 5     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#> 6     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#> 7     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#> 8     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#> 9     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 3deba644b69bab82
#>                                   parent_path   parent_version
#> 1 /tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2 7f798e3e0a8e977c
#> 2 /tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2 a6136378a2d9ae24
#> 3 /tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2 87dd6ee4ad3d4ec9
...
#> 5 /tmp/RtmpYzxMhd/s/data/welfare/PRY_2011.qs2 adacd011a6868f42
#> 6 /tmp/RtmpYzxMhd/s/data/welfare/PRY_2014.qs2 2748db71009938aa
#> 7        /tmp/RtmpYzxMhd/s/data/macro/cpi.qs2 aae53c4d934cc97f
#> 8        /tmp/RtmpYzxMhd/s/data/macro/gdp.qs2 522c12cd387f0223
#> 9 /tmp/RtmpYzxMhd/s/data/macro/population.qs2 87ab5d5168392691
```
...
#> ✔ Saved [qs2] → /tmp/RtmpYzxMhd/s/data/welfare/ARG_2015.qs2 @ version
#>   19be843f162487d3
...
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/ARG_2015.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2
#> ✔ Loaded [qs2] ← /tmp/RtmpYzxMhd/s/data/welfare/MEX_2015.qs2
...
#> ✔ Loaded [qs2] ←
#> /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2
#>    country  year reporting_level welfare_mean welfare_median welfare_sd
#>     <char> <int>          <char>        <num>          <num>      <num>
...
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=COL/reporting_level=urban/year=2010/part.qs2
#>   @ version cca266c9a368960c
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=COL/reporting_level=rural/year=2010/part.qs2
#>   @ version 7562c2104f50e1fc
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=COL/reporting_level=urban/year=2012/part.qs2
#>   @ version 7110c490d3dadec0
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=COL/reporting_level=rural/year=2012/part.qs2
#>   @ version 6c4c494ca01b0549
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=MEX/reporting_level=urban/year=2010/part.qs2
#>   @ version 7cb937efd5335b3d
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=MEX/reporting_level=rural/year=2010/part.qs2
#>   @ version 338afcdb221244c0
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=MEX/reporting_level=urban/year=2015/part.qs2
#>   @ version d6afab22173cafdd
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=MEX/reporting_level=rural/year=2015/part.qs2
#>   @ version a05f50b068c94fcc
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=PRY/reporting_level=national/year=2011/part.qs2
#>   @ version 57c5e71bc2e95f8b
#> ✔ Saved [qs2] →
#>   /tmp/RtmpYzxMhd/s/data/welfare_parts/country=PRY/reporting_level=national/year=2014/part.qs2
#>   @ version f148f57082a46b7d
st_list_parts(welfare_parts_dir)[1:6, ]
#>                                                                                        path
#> 1 /tmp/RtmpYzxMhd/s/data/welfare_parts/country=COL/reporting_level=rural/year=2010/part.qs2
#> 2 /tmp/RtmpYzxMhd/s/data/welfare_parts/country=COL/reporting_level=rural/year=2012/part.qs2
#> 3 /tmp/RtmpYzxMhd/s/data/welfare_parts/country=COL/reporting_level=urban/year=2010/part.qs2
#> 4 /tmp/RtmpYzxMhd/s/data/welfare_parts/country=COL/reporting_level=urban/year=2012/part.qs2
#> 5 /tmp/RtmpYzxMhd/s/data/welfare_parts/country=MEX/reporting_level=rural/year=2010/part.qs2
#> 6 /tmp/RtmpYzxMhd/s/data/welfare_parts/country=MEX/reporting_level=rural/year=2015/part.qs2
...
#> ✔ Saved [qs2] →
#> /tmp/RtmpYzxMhd/s/data/macro/cpi.qs2 @ version 85ded6ed4024c9b6
...
#>    level                                    child_path    child_version
#> 1      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 2      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 3      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 4      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 5      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 6      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 7      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 8      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 9      1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#> 10     1 /tmp/RtmpYzxMhd/s/outputs/welfare_summary.qs2 9e5e7015b8a262d6
#>                                    parent_path   parent_version
#> 1  /tmp/RtmpYzxMhd/s/data/welfare/ARG_2015.qs2 19be843f162487d3
#> 2  /tmp/RtmpYzxMhd/s/data/welfare/COL_2010.qs2 7f798e3e0a8e977c
#> 3  /tmp/RtmpYzxMhd/s/data/welfare/COL_2012.qs2 a6136378a2d9ae24
#> 4  /tmp/RtmpYzxMhd/s/data/welfare/MEX_2010.qs2 87dd6ee4ad3d4ec9
#> 5  /tmp/RtmpYzxMhd/s/data/welfare/MEX_2015.qs2 341d58478df6d396
#> 6  /tmp/RtmpYzxMhd/s/data/welfare/PRY_2011.qs2 adacd011a6868f42
#> 7  /tmp/RtmpYzxMhd/s/data/welfare/PRY_2014.qs2 2748db71009938aa
#> 8         /tmp/RtmpYzxMhd/s/data/macro/cpi.qs2 aae53c4d934cc97f
#> 9         /tmp/RtmpYzxMhd/s/data/macro/gdp.qs2 522c12cd387f0223
#> 10 /tmp/RtmpYzxMhd/s/data/macro/population.qs2 87ab5d5168392691
```
