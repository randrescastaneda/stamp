...
- Code hashing / provenance
  ([`st_hash_code()`](https://randrescastaneda.github.io/stamp/dev/reference/st_hash_code.md)),
- Optional file hashing
  ([`st_hash_file()`](https://randrescastaneda.github.io/stamp/dev/reference/st_hash_file.md)),
...
```
    ...
    ## ✔ Saved [qs2] → /tmp/Rtmprv23U1/demo.qs @
    ## version 0594164fc902acc4
...
```
    ...
    ##              <char>           <char>           <char>           <char>
    ## 1: 98d7fa9555f39f62 40c997f5d921cdff 7e25cdd35cd37239 488e8fa49c740261
    ## 2: 0594164fc902acc4 40c997f5d921cdff 1811ba4b2bd2a26a 488e8fa49c740261
    ##    size_bytes           created_at sidecar_format
    ##         <num>               <char>         <char>
    ## 1:        195 2025-11-26T15:30:29Z           both
    ## 2:        244 2025-11-26T15:30:29Z           both
...
```
    ...
    ## ✔ Loaded ← /tmp/Rtmprv23U1/demo.qs @
    ## 98d7fa9555f39f62 [qs2]
...
```
    ...
    ## Warning: No primary key recorded for /tmp/Rtmprv23U1/demo.qs.
    ## ℹ You can add one with `st_add_pk()`.

    ## ✔ Loaded [qs2] ← /tmp/Rtmprv23U1/demo.qs
