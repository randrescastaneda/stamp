...
```
    ...
    ## ✔ Saved [qs2] → /tmp/RtmpB3dyqK/A.qs @ version
    ## 2509a0d30736635d
...
```
    ...
    ## ✔ Saved [qs2] → /tmp/RtmpB3dyqK/B.qs @ version
    ## 969b441097558e12
...
```
    ...
    ## ✔ Saved [qs2] → /tmp/RtmpB3dyqK/C.qs @ version
    ## 589b0df8d0d44b50
...
```
    ...
    ## $sidecar
    ## $sidecar$path
    ## [1] "/tmp/RtmpB3dyqK/B.qs"
    ## 
    ## $sidecar$format
    ## [1] "qs2"
    ## 
    ## $sidecar$created_at
    ## [1] "2025-11-26T15:30:32Z"
    ## 
    ## $sidecar$size_bytes
    ## [1] 255
    ## 
    ...
    ## $sidecar$parents
    ##                   path       version_id
    ## 1 /tmp/RtmpB3dyqK/A.qs 2509a0d30736635d
    ## 
    ## $sidecar$attrs
    ## list()
    ## 
...
```
    ...
    ## 1     1 /tmp/RtmpB3dyqK/B.qs 969b441097558e12 /tmp/RtmpB3dyqK/A.qs
    ##     parent_version
    ## 1 2509a0d30736635d
...
```
    ...
    ##   level           child_path    child_version          parent_path
    ## 1     1 /tmp/RtmpB3dyqK/C.qs 589b0df8d0d44b50 /tmp/RtmpB3dyqK/B.qs
    ##     parent_version
    ## 1 969b441097558e12
...
```
    ...
    ## ✔ Registered builder for /tmp/RtmpB3dyqK/B.qs
    ## (default)
...
```
    ...
    ## ✔ Registered builder for /tmp/RtmpB3dyqK/C.qs
    ## (default)
...
```
    ...
    ## 1     1 /tmp/RtmpB3dyqK/C.qs upstream_changed      589b0df8d0d44b50
...
```
    ...
    ## $sidecar$parents
    ##                   path       version_id
    ## 1 /tmp/RtmpB3dyqK/B.qs 969b441097558e12
    ## 
    ## $sidecar$attrs
    ## list()
    ## 
    ...
    ## 
    ## $snapshot_dir
    ## /tmp/RtmpB3dyqK/.stamp/versions/C.qs/589b0df8d0d44b50
    ## 
    ## $parents
    ## $parents[[1]]
    ## $parents[[1]]$path
