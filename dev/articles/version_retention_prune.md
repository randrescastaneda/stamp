...
```
    ...
    ## ✔ stamp initialized
    ##   root: /tmp/RtmpoNoCYC/stamp-retention-example
    ##   state: /tmp/RtmpoNoCYC/stamp-retention-example/.stamp
...
```
    ...
    ## ✔ Saved [qs2] → /tmp/RtmpoNoCYC/stamp-retention-example/A.qs @ version
    ##   ddb83c40a018ac15
...
```
    ...
    ## ✔ Saved [qs2] → /tmp/RtmpoNoCYC/stamp-retention-example/B.qs @ version
    ##   0d63b143a018dca7
...
```
    ...
    ## ✔ Saved [qs2] → /tmp/RtmpoNoCYC/stamp-retention-example/C.qs @ version
    ##   0de16647e26fa16c
...
```
    ...
    ## /tmp/RtmpoNoCYC/stamp-retention-example/.stamp/versions
    ## ├── A.qs
    ## ├── B.qs
    ## └── C.qs
...
```
    ...
    ##              <char>                                       <char>
    ## 1: f760300a58cf2f08 /tmp/RtmpoNoCYC/stamp-retention-example/A.qs
    ##          version_id           created_at size_bytes
    ##              <char>               <char>      <num>
    ## 1: 171c5d99a890fe38 2025-11-26T15:31:03Z        243
...
```
    ...
    ## Empty data.table (0 rows and 5 cols): artifact_id,artifact_path,version_id,created_at,size_bytes
...
```
    ...
    ## ✔ Saved [qs2] → /tmp/RtmpoNoCYC/stamp-retention-example/inputs/population.qs @
    ##   version 518ce3505e8577cb
...
```
    ...
    ## ✔ Loaded [qs2] ← /tmp/RtmpoNoCYC/stamp-retention-example/inputs/population.qs
    ## ✔ Recorded primary key for
    ##   /tmp/RtmpoNoCYC/stamp-retention-example/inputs/population.qs --> country,
...
```
    ...
    ## ✔ Loaded [qs2] ←
    ## /tmp/RtmpoNoCYC/stamp-retention-example/inputs/population.qs
...
- [`.st_catalog_read()`](https://randrescastaneda.github.io/stamp/dev/reference/dot-st_catalog_read.md)
...
```
    ...
    ## ✔ Saved [qs2] →
    ##   /tmp/RtmpoNoCYC/stamp-retention-example/inputs/country_year/country=PER/year=2023/part.qs2
    ##   @ version c878c2a35760ab2b
...
```
    ...
    ## ✔ Saved [qs2] →
    ##   /tmp/RtmpoNoCYC/stamp-retention-example/inputs/country_year/country=MEX/year=2022/part.qs2
    ##   @ version 5d9806e12de26e6b
...
```
    ...
    ##                                                                                         path
    ## 1 /tmp/RtmpoNoCYC/stamp-retention-example/inputs/country_year/country=MEX/year=2022/part.qs2
    ## 2 /tmp/RtmpoNoCYC/stamp-retention-example/inputs/country_year/country=PER/year=2023/part.qs2
    ##   country year
    ## 1     MEX 2022
    ## 2     PER 2023
...
```
    ...
    ##                                                                                         path
    ## 1 /tmp/RtmpoNoCYC/stamp-retention-example/inputs/country_year/country=PER/year=2023/part.qs2
    ##   country year
    ## 1     PER 2023
