...
```
    ...
    ## ✔ Saved [qs2] → /tmp/RtmpvWgAYM/demo.qs @
    ## version 6118b957a79437c7
...
```
    ...
    ##              <char>           <char>           <char>           <char>
    ## 1: 9b6f8822d6fcbde5 c1525c1cb9e742d0 f05f2ec030741db5 488e8fa49c740261
    ## 2: 6118b957a79437c7 c1525c1cb9e742d0 d73e0bf1cb9d8dc5 488e8fa49c740261
    ##    size_bytes           created_at sidecar_format
    ##         <num>               <char>         <char>
    ## 1:        154 2025-11-12T23:05:33Z           both
    ## 2:        201 2025-11-12T23:05:33Z           both
...
```
    ...
    ## ✔ Loaded ← /tmp/RtmpvWgAYM/demo.qs @
    ## 9b6f8822d6fcbde5 [qs2]
...
```
    ...
    ## Warning: No primary key recorded for /tmp/RtmpvWgAYM/demo.qs.
    ## ℹ You can add one with `st_add_pk()`.

    ## ✔ Loaded [qs2] ← /tmp/RtmpvWgAYM/demo.qs
