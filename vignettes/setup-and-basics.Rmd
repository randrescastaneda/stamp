---
title: "01.Setup & Basics"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{01.Setup & Basics}
...
If you'd like, I can similarly update the other vignettes in `vignettes/` to
reflect the current implementation and add small unit-test-like examples.
