...
- **Parallel processing** where partitions can be proceEssed independently
...
Note: character partition values are normalized to lowercase in paths and loaded data. Match using lowercase or use case-insensitive formulas.
...
# 3. Process (compute ratio from income and consumption)
