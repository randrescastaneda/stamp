...
**Storage model (v0.0.9+):** Artifacts are stored as `<root>/<path>/<filename>/<filename>`
with version history in `<root>/<path>/<filename>/versions/`. The `.stamp/` directory
within each aliased root contains only state (catalog, locks, temp files).
